...
const TABLE_NAME = 'season2_survey';
...
form.addEventListener('submit', async (e) => {
  ...
  const payload = {
    ...
    build_idea: fd.get('build_idea')?.trim() || null,

    // 경험
    coding: fd.get('coding'),
    claude_code: fd.get('claude_code'),
    deploy_exp: fd.get('deploy_exp'),

    // 구글 플레이 개발자 계정
    play_account: fd.get('play_account'),
    business: fd.get('business'),

    // 참석
    attend: fd.get('attend'),
    holiday: fd.get('holiday'),
    week0: fd.getAll('week0'),
